...
#define bfcp_mutex2_init(a,b) PfcSemBCreate(a)
#define bfcp_mutex2_destroy(a) PfcSemDelete(a)
#define bfcp_mutex2_lock(a) PfcSemTake(a)
#define bfcp_mutex2_unlock(a) PfcSemGive(a)
...
PROTO_API BOOL32 Str2SockAddr(OUT TBfcpSock_Addr* ptAddr, IN const s8 *Str, IN u16 port);

PROTO_API BOOL32 SockAddr2Str(IN TBfcpSock_Addr const *ptAddr, OUT s8 *Str, OUT u16 &port);
...
void BfcpPrintf(u32 dwLevel, const s8 *pFormat, ...);
