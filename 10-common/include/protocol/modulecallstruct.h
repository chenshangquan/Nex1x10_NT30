...
#define MAX_USERNAME_LEN		64			///<  For SIP DIGEST authorization, be noticed that LEN_USERNAME is defined with 64 in kdvsipcommon.h
...
enum EmModuleCallDisconnectReason
{
	...
	emModuleDisconnect_NonExistNum    ///< Number does not exist
...
typedef struct tagTCapSetInfo
{
	...
	EmModuleH264NALMode   m_emH264NALMode;  ///< nal mode
...
enum emModuleType 
{
	emModuleService = 0x01,
	emModuleStackin = 0x02,
	emModuleStackout = 0x04,
	emModuleCapSet = 0x08,
	emModule = 0x10,
};
